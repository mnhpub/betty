/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 570b721db6994e4de44eb49bc5614988)
// Runtime types generated with workerd@1.20260708.1 2026-07-09 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	CF_DEPLOYMENT: "true";
	API_URL: string;
	API: Fetcher /* betty-api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_DEPLOYMENT" | "API_URL">> {}
}
